...
merged_df |>
  ggplot(aes(x = P_christ.x, y = 0, color = cluster_P1)) +  # Set y to a constant value
  geom_point(position = position_jitter(height = 0.05), size = 2) +  # Add jitter to y to slightly separate points
  theme_minimal() +
