...
plot_server <- function(id, data) {
  moduleServer(id, function(input, output, session) {
    ...
    custom_labels <- c("2" = "Extremely Lazy", "3" = "Relatively Neutral", "1" = "Slightly Duty-inclined")
    ...
    output$interactive_plot <- renderGirafe({
      ...
      plot <- ggplot() +
        ...
        labs(
          ...
          x = 'Note: the more rightward, the more dutiful is the connotation of "Virginia"',
          y = ""
        ) +
        theme(
